...
namespace Fusion.XR
{
    ...
    public class RigidbodyMover : Movement
    {
        ...
        public override void Move(Vector3 direction)
        {
            ...
            //if(Physics.SphereCast(head.position, Player.main.collisionAdjuster.p_CollisionRadius, Vector3.down, out RaycastHit hit, Player.main.collisionAdjuster.p_localHeight + 0.1f))
